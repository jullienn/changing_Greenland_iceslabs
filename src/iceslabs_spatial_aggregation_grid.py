...
df_2010_2018 = pd.read_csv(path+'Ice_Layer_Output_Thicknesses_2010_2018_jullienetal2021_prob01.csv',delimiter=',',decimal='.')
...
df_2010.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2010_jullienetal2021_prob01.csv',header=True)
df_2011.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2011_jullienetal2021_prob01.csv',header=True)
df_2012.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2012_jullienetal2021_prob01.csv',header=True)
df_2013.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2013_jullienetal2021_prob01.csv',header=True)
df_2014.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2014_jullienetal2021_prob01.csv',header=True)
df_2017.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2017_jullienetal2021_prob01.csv',header=True)
df_2018.to_csv(path_or_buf=path+'Ice_Layer_Output_Thicknesses_2018_jullienetal2021_prob01.csv',header=True)
...
filename_to_save='jullien_etal_20102018_spatial_aggregation_grid_'+str(a)+'_prob01.xlsx'
