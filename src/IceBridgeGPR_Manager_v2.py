...
class Mask_Manager():
    ...
    def __init__(self):
        ...
        self.valid_mask_filenames = [ICEBRIDGE_EXCLUSIONS_SURFACE_PICK_FILE, ICEBRIDGE_EXCLUSIONS_SURFACE_MISMATCH_FILE, ICEBRIDGE_EXCLUSIONS_LAKES_OTHER_FILE, ICEBRIDGE_EXCLUSIONS_DRY_FIRN, ICEBRIDGE_EXCLUSIONS_OBVIOUS, ICEBRIDGE_EXCLUSIONS_ABLATION]#, ICEBRIDGE_EXCLUSIONS_16M]
...
class IceBridgeGPR_Track_v2():
    ...
    def save_radar_slice_to_picklefile(self, meters_cutoff_above=0, meters_cutoff_below=100):
        ...
        maskfilenames = [ICEBRIDGE_EXCLUSIONS_SURFACE_PICK_FILE,ICEBRIDGE_EXCLUSIONS_SURFACE_MISMATCH_FILE, ICEBRIDGE_EXCLUSIONS_LAKES_OTHER_FILE, ICEBRIDGE_EXCLUSIONS_DRY_FIRN, ICEBRIDGE_EXCLUSIONS_OBVIOUS, ICEBRIDGE_EXCLUSIONS_ABLATION]#, ICEBRIDGE_EXCLUSIONS_16M]
    ...
    def perform_roll_correction(self, export=True, max_depth_m=100):
        ...
        trace_masks = [ICEBRIDGE_EXCLUSIONS_SURFACE_PICK_FILE,ICEBRIDGE_EXCLUSIONS_SURFACE_MISMATCH_FILE, ICEBRIDGE_EXCLUSIONS_LAKES_OTHER_FILE, ICEBRIDGE_EXCLUSIONS_DRY_FIRN, ICEBRIDGE_EXCLUSIONS_OBVIOUS, ICEBRIDGE_EXCLUSIONS_ABLATION]#, ICEBRIDGE_EXCLUSIONS_16M]
        # Read the raw traces
